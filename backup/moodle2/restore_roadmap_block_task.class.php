...
/**
 * The task that provides a complete restore of block_roadmap is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/roadmap/backup/moodle2/restore_roadmap_stepslib.php');

/**
 * Restore task for block_roadmap.
 */
class restore_roadmap_block_task extends restore_block_task {
