...
require_once($CFG->dirroot.'//blocks/roadmap/backup/moodle2/backup_roadmap_stepslib.php');
require_once($CFG->dirroot.'//blocks/roadmap/backup/moodle2/backup_roadmap_settingslib.php');

/**
 * Provides all the settings and steps to perform a complete backup of block_roadmap.
 */
class backup_roadmap_block_task extends backup_block_task {
